...
I had to dramatically scale back this release in order to get something pushed out early. I was trying to get too much out at the same time. I also wanted to publish something earlier to get feedback. I apologize in advance if this release is not as stable as the previous one. 
...
. Buildings: Causeway, Dolmen, Gathering Rock, Shelter, Camp
. Resources: Flint (fighting bonus), Pig, Clay, Chickens (TBD), Tin, Berries, Wood
. Units: (Early exporing unit - name tbd), (Early spear unit - name tbd), Axeman, Slinger
. Resorce Units: Hunter, Gatherer, Villager
. Eras (transforming Ancient and Prehistoric): Prehistoric > Cooper > Bronze > Iron
. Technologies (still working on next tech tree changes)
