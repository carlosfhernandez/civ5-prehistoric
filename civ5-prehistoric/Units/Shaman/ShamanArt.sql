INSERT INTO ArtDefine_StrategicView (StrategicViewType, TileType, Asset)
	VALUES	('ART_DEF_UNIT_SHAMAN',     'Unit', 'Shaman_sv.dds');

INSERT INTO "ArtDefine_UnitInfos" ('Type','DamageStates','Formation')
	SELECT	("ART_DEF_UNIT_SHAMAN"),    "DamageStates", ("UnFormed")
	FROM "ArtDefine_UnitInfos" 
  WHERE (Type = "ART_DEF_UNIT_SCOUT");

INSERT INTO "ArtDefine_UnitInfoMemberInfos" ('UnitInfoType','UnitMemberInfoType','NumMembers')
	VALUES	("ART_DEF_UNIT_SHAMAN",     "ART_DEF_UNIT_MEMBER_SHAMAN",     "10");
...
INSERT INTO "ArtDefine_UnitMemberCombats" ('UnitMemberType', 'EnableActions', 'DisableActions', 
	...
	SELECT	("ART_DEF_UNIT_MEMBER_SHAMAN"),     "EnableActions", "DisableActions", "MoveRadius", 
...
INSERT INTO "ArtDefine_UnitMemberCombatWeapons" ('UnitMemberType', 'Index', 'SubIndex', 'ID', 
	...
	SELECT ("ART_DEF_UNIT_MEMBER_SHAMAN"),    "Index", "SubIndex", "ID", "VisKillStrengthMin", 
...
INSERT INTO "ArtDefine_UnitMemberInfos" ("Type", "Scale", "ZOffset", "Domain", "Model", 
	...
	SELECT	("ART_DEF_UNIT_MEMBER_SHAMAN"),    (0.135), "ZOffset", "Domain", ("Shaman.fxsxml"), 
    "MaterialTypeTag", "MaterialTypeSoundOverrideTag"
