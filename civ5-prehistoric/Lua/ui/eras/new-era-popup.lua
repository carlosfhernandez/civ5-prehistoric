-- new-era-popup
-- Author: carlos
-- DateCreated: 5/16/2014 8:21:28 PM
--------------------------------------------------------------
...
function OnPopup( popupInfo )
  ...
  elseif (strEra == "ERA_PREHISTORIC") then
    lastBackgroundImage = "era_prehistoric.dds";
  elseif (strEra == "ERA_LOWERPALEOLITHIC") then
    lastBackgroundImage = "era_lowerpaleolithic.dds";
